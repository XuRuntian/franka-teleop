...
flags.DEFINE_string("output", "/media/franka/WD_BLACK/franka_data", "output home directory.")
flags.DEFINE_string("date", "250328", "date of the collection.")
            ...
            if key == ord('w') or key == ord('W'):
                ...
                with h5py.File(h5_filename, 'w') as f:
                    ...
                    images_group.create_dataset('front_image', 
                                             data=np.array(front_images, dtype=np.uint8))
                    images_group.create_dataset('wrist_image', 
                                             data=np.array(wrist_images, dtype=np.uint8))
